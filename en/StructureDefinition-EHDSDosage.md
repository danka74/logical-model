# Dosage model - EHDS Logical Information Models v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/eu.ehds.models|current/StructureDefinition/EHDSDosage)
...
```json
{
  ...
  "id" : "EHDSDosage",
  "url" : "http://ehds.eu/fhir/models/StructureDefinition/EHDSDosage",
  "version" : "0.1.0",
  "name" : "EHDSDosage",
  "title" : "Dosage model",
  "status" : "draft",
