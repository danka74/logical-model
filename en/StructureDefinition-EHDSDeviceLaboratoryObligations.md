# Device laboratory specific obligations - EHDS Logical Information Models v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/eu.ehds.models|current/StructureDefinition/EHDSDeviceLaboratoryObligations)
...
```json
{
  ...
  "url" : "http://ehds.eu/fhir/models/StructureDefinition/EHDSDeviceLaboratoryObligations",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://ehds.eu/fhir/models/StructureDefinition/EHDSDevice",
  "baseDefinition" : "http://ehds.eu/fhir/models/StructureDefinition/EHDSDevice",
