# MedicationUse obligations - EHDS Logical Information Models v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/eu.ehds.models|current/StructureDefinition/EHDSMedicationUseObligations)
...
```json
{
  ...
  "url" : "http://ehds.eu/fhir/models/StructureDefinition/EHDSMedicationUseObligations",
  "version" : "0.1.0",
  ...
  "baseDefinition" : "http://ehds.eu/fhir/models/StructureDefinition/EHDSMedicationUse",
