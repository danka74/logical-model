...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/eu.ehds.models|current/StructureDefinition/EHDSDevice)
...
```json
{
  ...
  "id" : "EHDSDevice",
  "url" : "http://ehds.eu/fhir/models/StructureDefinition/EHDSDevice",
  "version" : "0.1.0",
  "name" : "EHDSDevice",
  "title" : "Device model",
  "status" : "draft",
