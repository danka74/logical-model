# Imaging study model - EHDS Logical Information Models v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/eu.ehds.models|current/StructureDefinition/EHDSImagingStudy)
...
```json
{
  ...
  "id" : "EHDSImagingStudy",
  "url" : "http://ehds.eu/fhir/models/StructureDefinition/EHDSImagingStudy",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "*",
      "type" : [{
        "code" : "http://ehds.eu/fhir/models/StructureDefinition/EHDSEndpoint"
      }]
    },
    {
